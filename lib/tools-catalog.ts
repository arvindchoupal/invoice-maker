...
export const TOOLS_CATALOG: ToolCatalogEntry[] = [
  ...
  },
  {
    ...
    body: "Add or remove GST online with CGST, SGST and IGST split.",
    tag: "GST",
    intent: "Best for tax invoices",
    metaTitle: "Free GST Calculator | Add or Remove GST Online",
    metaDescription:
      "Free GST calculator for India. Add GST to a price or remove GST from an inclusive amount with CGST, SGST and IGST split for invoices and bills.",
    headline: "Add or remove GST online before you create a bill.",
    highlights: ["Add GST or remove GST", "CGST, SGST and IGST split", "Useful for invoices, bills and quotations"],
  ...
  },
  {
    ...
    title: "Free invoice number generator",
    body: "Generate invoice numbers like INV-0001, FY26-0001 and GST-2026-001.",
    tag: "Invoice",
    intent: "Best for new businesses",
    metaTitle: "Free Invoice Number Generator | GST Invoice Format",
    metaDescription:
      "Generate free invoice numbers with GST, financial year, monthly and client-wise formats. Create clean invoice IDs like INV-0001 or FY26-0001.",
    headline: "Generate a clean invoice number in seconds.",
    highlights: ["GST and FY invoice formats", "Copy-ready invoice IDs", "Examples for freelancers and businesses"],
    signupSource: "invoice-number-generator",
  },
  {
    href: "/tools/gst-bill-format-generator",
    title: "GST bill format generator",
    body: "Create a GST bill format preview with seller, buyer, taxable value, tax split and total.",
    tag: "GST",
    intent: "Best for GST bill format searches",
    metaTitle: "Free GST Bill Format Generator | Create GST Bill Online",
    metaDescription:
      "Create a free GST bill format online with invoice number, buyer details, taxable value, CGST, SGST, IGST and total. Useful for Indian GST invoices.",
    headline: "Create a GST bill format preview before making the invoice.",
    highlights: ["GST bill format preview", "CGST/SGST or IGST breakup", "CTA to create a PDF invoice"],
    signupSource: "gst-bill-format-generator",
  },
  {
