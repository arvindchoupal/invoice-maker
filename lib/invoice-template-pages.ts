...
export const INVOICE_TEMPLATE_PAGES: InvoiceTemplatePage[] = [
  ...
  },
  {
    ...
    title: "Electrician Bill Format and Invoice Template | Free PDF",
    description: "Use a free electrician bill format for labour, wiring, fixtures, testing and GST. See realistic line items and create a professional PDF invoice online.",
    h1: "Electrician Bill Format and Invoice Template",
  ...
  },
  {
    ...
    primaryKeyword: "transportation invoice template",
    title: "Transportation Invoice Template | Transport Bill Format",
    ...
    h1: "Transportation Invoice Template for Trips and Freight",
    ...
    searchIntents: ["transportation invoice template", "transport invoice template", "transport invoice format", "transport bill format", "freight bill format", "how to make transport bill", "goods transport invoice"],
